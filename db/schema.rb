...
ActiveRecord::Schema.define(version: 2022_11_27_220076) do
  ...
  create_table "redcap2omop_omop_columns", force: :cascade do |t|
  ...
  create_table "redcap2omop_omop_tables", force: :cascade do |t|
    t.string "domain"
    t.string "name", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "redcap2omop_redcap_data_dictionaries", force: :cascade do |t|
  ...
  create_table "redcap2omop_redcap_derived_date_choice_offset_mappings", force: :cascade do |t|
    t.integer "redcap_derived_date_id", null: false
    t.integer "redcap_variable_choice_id", null: false
    t.integer "offset_days"
  end

  create_table "redcap2omop_redcap_derived_dates", force: :cascade do |t|
    t.string "name", null: false
    t.integer "base_date_redcap_variable_id"
    t.integer "offset_redcap_variable_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "parent_redcap_derived_date_id"
    t.integer "offset_interval_days"
    t.string "offset_interval_direction"
    t.integer "redcap_data_dictionary_id", null: false
  end

  create_table "redcap2omop_redcap_event_map_dependents", force: :cascade do |t|
  ...
  create_table "redcap2omop_redcap_event_maps", force: :cascade do |t|
    t.integer "redcap_event_id", null: false
    t.integer "concept_id"
    t.integer "omop_column_id"
    t.datetime "deleted_at"
  ...
  create_table "redcap2omop_redcap_events", force: :cascade do |t|
    t.integer "redcap_data_dictionary_id", null: false
  ...
  create_table "redcap2omop_redcap_projects", force: :cascade do |t|
  ...
  create_table "redcap2omop_redcap_source_links", force: :cascade do |t|
  ...
  create_table "redcap2omop_redcap_variable_child_maps", force: :cascade do |t|
  ...
  create_table "redcap2omop_redcap_variable_choice_maps", force: :cascade do |t|
    t.integer "redcap_variable_choice_id", null: false
    t.integer "concept_id"
    t.integer "omop_column_id"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "redcap2omop_redcap_variable_choices", force: :cascade do |t|
    t.integer "redcap_variable_id", null: false
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.datetime "deleted_at"
    t.boolean "deleted_in_next_data_dictionary"
  end

  create_table "redcap2omop_redcap_variable_maps", force: :cascade do |t|
    t.integer "redcap_variable_id", null: false
    t.integer "concept_id"
    t.integer "omop_column_id"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "redcap2omop_redcap_variables", force: :cascade do |t|
    t.integer "redcap_data_dictionary_id", null: false
    t.string "name", null: false
